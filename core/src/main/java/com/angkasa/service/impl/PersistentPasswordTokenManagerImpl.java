...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.angkasa.service.impl.PasswordTokenManager#generateRecoveryToken(com.angkasa.model.User)
     */
    @Override
    ...
    /**
     * @see com.angkasa.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.angkasa.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.angkasa.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
